...
SuperAntigravity supercharges [Google Antigravity](https://antigravity.google) with a complete AI-assisted development workflow — 19 auto-triggered skills, 16 slash commands, and 6 specialist agents — all installed with a single command.
...
<CardGroup cols={3}>
  ...
  <Card title="6 Specialist Agents" icon="robot">
    Dedicated agents for code review, architecture, security, research, and mentoring.
  </Card>
</CardGroup>
...
| Agents | 6 | `~/.gemini/antigravity/agents/` |
